...
```
This is super basic and literal. It is unoptimized. The next check is an optomization pass, where the AST drops so much literalness, and pattern matches things.
